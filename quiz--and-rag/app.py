...
def generate_quiz(user_id):
    ...
    try:
        ...
        if data['cache_id'].startswith(f'yt_{user_id}_'):
            ...
            questions = quiz_generator.generate_quiz([transcript], params)
            ...
            questions = quiz_generator.generate_quiz(all_docs['documents'], params)
        else:
        ...
        # Cache the generated quiz (cache the transformed questions)
        cache_manager.save_to_cache(transformed_questions, quiz_cache_id)
